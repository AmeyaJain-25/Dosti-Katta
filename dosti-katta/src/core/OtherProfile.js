...
const OtherProfile = ({ match }) => {
  ...
  return (
    ...
    //                 }}
    //               ></i>
    //               <p style={{ padding: "0", margin: "0", fontSize: "1.2em" }}>
    //                 UnFollow
    //               </p>
    //             </button>
    //           ) : (
